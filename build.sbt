...
lazy val library =
  new {
    ...
    val validator         = "commons-validator"      % "commons-validator"     % Version.commonValidator
    val simulacrum        = "com.github.mpilquist"   %% "simulacrum"           % Version.SimulacrumVersion
